<div class="div">
    ...
    <button id="btnPesan"
    class="btn btn-primary mt-3" style="width: 150px; margin-left: 45px" data-bs-toggle="modal" data-product="{{  $item->product_id }}" data-amount="{{ $jumlah }}" data-productname ="{{ $product_name }}" data-cart="{{ $item->id }}" data-bs-target="#orderModal" {{ $jumlah>0?'':'disabled' }}>Pesan</button>
